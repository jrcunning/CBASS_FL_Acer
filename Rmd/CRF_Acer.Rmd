...
b1log <- readlog("data/20201013_CRF_Acer/temperature/sdlog/20201013_BOX1_LOG.TXT", prefix = "B1")
b3log <- readlog("data/20201013_CRF_Acer/temperature/sdlog/20201013_BOX3_LOG.TXT", prefix = "B3")
...
hobologfiles <- list.files("data/20201013_CRF_Acer/temperature/hobo", pattern = ".xlsx", full.names = TRUE)
...
path <- "data/20201013_CRF_Acer/PAM/20201013dii_Acer.xlsx"
dpii <- path %>%
  excel_sheets() %>%
  set_names() %>%
...
write_csv(dpii, "data/20201013_CRF_Acer/PAM/CRF_pamdata.csv")
```
