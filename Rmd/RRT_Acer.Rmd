---
title: "Reef Renewal Tavernier *A. cervicornis* CBASS"
...
b1log <- readlog("data/20201007_RRT_Acer/temperature/sdlog/20201007_BOX1_LOG.TXT", prefix = "B1")
b2log <- readlog("data/20201007_RRT_Acer/temperature/sdlog/20201007_BOX2_LOG.TXT", prefix = "B2")
b3log <- readlog("data/20201007_RRT_Acer/temperature/sdlog/20201007_BOX3_LOG.TXT", prefix = "B3")
...
hobologfiles <- list.files("data/20201007_RRT_Acer/temperature/hobo", pattern = ".xlsx", full.names = TRUE)
...
path <- "data/20201007_RRT_Acer/PAM/20201007dii_Acer.xlsx"
dpii <- path %>%
  excel_sheets() %>%
  set_names() %>%
...
write_csv(dpii, "data/20201007_RRT_Acer/PAM/RRT_Acer_pamdata.csv")
```
...
dpiif <- dpii %>%
  ...
  # Filter out ML-1 at 32°C -- no data!
  filter(!(geno == "ML1" & max_temp == 32)) %>%
