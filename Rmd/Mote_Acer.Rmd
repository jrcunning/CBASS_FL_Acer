...
b1log <- readlog("data/20201011_Mote_Acer/temperature/sdlog/20201011_BOX1_LOG.TXT", prefix = "B1")
b2log <- readlog("data/20201011_Mote_Acer/temperature/sdlog/20201011_BOX2_LOG.TXT", prefix = "B2")
...
hobologfiles <- list.files("data/20201011_Mote_Acer/temperature/hobo", pattern = ".xlsx", full.names = TRUE)
...
path <- "data/20201011_Mote_Acer/PAM/20201011dii_Acer.xlsx"
dpii <- path %>%
  excel_sheets() %>%
  set_names() %>%
...
write_csv(dpii, "data/20201011_Mote_Acer/PAM/Mote_pamdata.csv")
```
