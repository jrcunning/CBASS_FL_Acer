...
b1log <- readlog("data/20201010_FWC_Acer/temperature/sdlog/20201010_BOX1_LOG.TXT", prefix = "B1")
b2log <- readlog("data/20201010_FWC_Acer/temperature/sdlog/20201010_BOX2_LOG.TXT", prefix = "B2")
...
hobologfiles <- list.files("data/20201010_FWC_Acer/temperature/hobo", pattern = ".xlsx", full.names = TRUE)
...
path <- "data/20201010_FWC_Acer/PAM/20201010_dii_bytank.xlsx"
dpii <- path %>%
  excel_sheets() %>%
  set_names() %>%
...
write_csv(dpii, "data/20201010_FWC_Acer/PAM/FWC_pamdata.csv")
```
