...
vennd <- euler(mat[, 7:2], shape = "ellipse")
vd <- plot(vennd, quantities = list(cex = 0.5), legend = TRUE,
     fills = list(fill = rev(c("#F8766D", "#B79F00", "#00BA38", "#00BFC4", "#619CFF", "#F564E3")), alpha = 0.6))
png(filename = "output/figS1.png", width = 90, height = 90, units = "mm", res = 300)
grid::grid.draw(vd)
dev.off()
```

![](../output/figS1.png){width=50%}
...
(corfig <- ggpairs(cors, diag = list(continuous = "blankDiag")) +
  theme_few() +
