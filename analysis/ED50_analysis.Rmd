...
hist1 <- res %>%
  ...
  xlim(qnorm(c(0.0001, 0.999999), meanadj, sdadj))
...
top10plot
newfig <- cowplot::plot_grid(lat.plot, lon.plot, mmm5.plot, top10plot, nrow = 2,
                   labels = "AUTO")
ggsave("output/fig3.png", plot = newfig, width = 90, height = 80, units = "mm")
```
