...
ggsave(filename = "output/figS1.png", width = 120, height = 87, units = "mm")
...
```{r, include = FALSE, eval = FALSE, fig.width = 11, fig.height = 3}
...
top10plot <- ggplot(data = world) +
  ...
  geom_point(aes(x = source_lon, y = source_lat), data = top10, color = "red", size = 1.5, alpha = 1, pch = "X") +
...
top10plot
newfig3 <- cowplot::plot_grid(lat.plot, lon.plot, mmm5.plot, top10plot, nrow = 2,
                   labels = "AUTO")
...
fig4
ggsave("output/fig4.png", width = 114, height = 60, units = "mm")
```
